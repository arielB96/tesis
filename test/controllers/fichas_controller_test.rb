...
class FichasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ficha" do
    assert_difference('Ficha.count') do
      post fichas_url, params: { ficha: { especialidad: @ficha.especialidad, fichaNum: @ficha.fichaNum } }
    end
  ...
  test "should update ficha" do
    patch ficha_url(@ficha), params: { ficha: { especialidad: @ficha.especialidad, fichaNum: @ficha.fichaNum } }
