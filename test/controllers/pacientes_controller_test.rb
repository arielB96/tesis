...
class PacientesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create paciente" do
    assert_difference('Paciente.count') do
      post pacientes_url, params: { paciente: { apellido: @paciente.apellido, ci: @paciente.ci, edad: @paciente.edad, etnia: @paciente.etnia, lugarNacimiento: @paciente.lugarNacimiento, nacionalidad: @paciente.nacionalidad, nombre: @paciente.nombre, sexo: @paciente.sexo } }
    end
  ...
  test "should update paciente" do
    patch paciente_url(@paciente), params: { paciente: { apellido: @paciente.apellido, ci: @paciente.ci, edad: @paciente.edad, etnia: @paciente.etnia, lugarNacimiento: @paciente.lugarNacimiento, nacionalidad: @paciente.nacionalidad, nombre: @paciente.nombre, sexo: @paciente.sexo } }
