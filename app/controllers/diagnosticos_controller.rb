class DiagnosticosController < ApplicationController
  ...
  private
    ...
    def diagnostico_params
      params.require(:diagnostico).permit(:fecha, :hora, :axilaRectal, :presionArterial, :pulso, :freCardiaca, :freRespi, :peso, :talla, :perimeCefalico, :masaCorpo, :circuAbdomi, :estadNutricional, :alimentacion, :desarrolloMadura, :tanner, :vacucacionVigente, :areaTecEspecialidades, :nuevo, :motivoConsul, :diagnostico, :examenFisico, :otroDiagnos, :tratamiento)
    end
end
